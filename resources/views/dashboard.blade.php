        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100 flex items-center gap-4">
                    ...
                    <div>
                        <div class="text-sm text-gray-500 font-bold uppercase tracking-wider">Total Posts</div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100 flex items-center gap-4">
                    ...
                    <div>
                        <div class="text-sm text-gray-500 font-bold uppercase tracking-wider">Total Views</div>
