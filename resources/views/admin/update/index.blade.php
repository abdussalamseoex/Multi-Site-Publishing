            ...
            <div class="bg-white shadow-sm sm:rounded-lg overflow-hidden border border-gray-200">
                <div class="p-6 md:p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div class="md:col-span-1 hidden md:flex items-center justify-center bg-gray-50 rounded-lg border border-dashed border-gray-300 relative overflow-hidden">
                            @if(isset($githubStatus) && $githubStatus === 'connected')
                                <div class="text-center p-6 text-green-600">
                                    <svg class="mx-auto h-12 w-12 text-green-500 mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                    <p class="text-xs tracking-widest uppercase font-bold text-green-700">GitHub Connected</p>
                                    <p class="text-[10px] text-green-500 mt-1">Ready to sync</p>
                                </div>
                            @elseif(isset($githubStatus) && $githubStatus === 'error')
                                <div class="text-center p-6 text-red-600">
                                    <svg class="mx-auto h-12 w-12 text-red-500 mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                    <p class="text-xs tracking-widest uppercase font-bold text-red-700">Connection Failed</p>
                                    <p class="text-[10px] text-red-500 mt-1 max-w-[150px] truncate" title="{{ $githubMessage }}">{{ $githubMessage }}</p>
                                </div>
                            @else
                                <div class="text-center p-6 text-gray-400">
                                    ...
                                    <p class="text-xs tracking-widest uppercase font-semibold">Unknown Status</p>
                                </div>
                            @endif
                        </div>
                    </div>
