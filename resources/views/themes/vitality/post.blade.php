...
<body class="antialiased">
    ...
    <div class="bg-white border-b border-slate-200">
        <div class="max-w-4xl mx-auto px-4 py-16 text-center">
            ...
            <h1 class="text-3xl sm:text-4xl md:text-5xl font-wellness font-bold leading-snug mb-6 text-slate-800 break-words">{{ $post->title }}</h1>
            ...
            <div class="flex items-center justify-center gap-4 text-slate-500 text-sm font-medium">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-slate-700 font-bold"><a href="{{ route('frontend.author', $post->user->slug ?? ($post->user->id ?? 1)) }}" class="hover:text-emerald-600 transition">{{ $post->user->name ?? 'Health Editor' }}</a></span>
                </div>
